      ...
      <aside className={`${sidebarOpen ? "w-64" : "w-16"} bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 flex flex-col transition-all duration-300 hidden lg:flex`}>
        ...
        <nav className="flex-1 p-3 space-y-1 overflow-y-auto">
          ...
          <div className="pt-4 border-t border-gray-200 dark:border-gray-700 mt-4">
            ...
            <NavItem icon={PieChart} label="Unified Analytics" path="/unified-analytics" />
            <NavItem icon={Bot} label="Agent Registry" path="/admin/agents" />
            <NavItem icon={Brain} label="LLM Settings" path="/admin/llm-settings" />
          </div>
