...
export const PROVIDER_MANIFESTS: ProviderManifest[] = [
  {
    ...
    models: [
      { id: "gpt-5.2", name: "GPT-5.2 Thinking", contextWindow: 200000, maxOutput: 100000, inputCostPer1M: 5, outputCostPer1M: 20, capabilities: ["text", "vision", "reasoning", "code"], isDefault: true, isActive: true },
      { id: "gpt-5.2-pro", name: "GPT-5.2 Pro", contextWindow: 200000, maxOutput: 100000, inputCostPer1M: 15, outputCostPer1M: 60, capabilities: ["reasoning", "code"], isActive: true },
      { id: "gpt-5.2-instant", name: "GPT-5.2 Instant", contextWindow: 200000, maxOutput: 32768, inputCostPer1M: 2.5, outputCostPer1M: 10, capabilities: ["text", "vision", "multimodal", "fast"], isActive: true },
      { id: "gpt-5.2-codex", name: "GPT-5.2 Codex", contextWindow: 200000, maxOutput: 100000, inputCostPer1M: 10, outputCostPer1M: 40, capabilities: ["code", "reasoning"], isActive: true },
      { id: "gpt-5.1", name: "GPT-5.1 Thinking", contextWindow: 200000, maxOutput: 100000, inputCostPer1M: 5, outputCostPer1M: 20, capabilities: ["text", "vision", "reasoning", "code"], isActive: true },
      { id: "gpt-5", name: "GPT-5", contextWindow: 200000, maxOutput: 100000, inputCostPer1M: 5, outputCostPer1M: 20, capabilities: ["text", "vision", "reasoning", "code"], isActive: true },
      { id: "gpt-5-mini", name: "GPT-5 Mini", contextWindow: 200000, maxOutput: 32768, inputCostPer1M: 1.5, outputCostPer1M: 6, capabilities: ["text", "code", "fast"], isActive: true },
      { id: "gpt-5-nano", name: "GPT-5 Nano", contextWindow: 128000, maxOutput: 16384, inputCostPer1M: 0.5, outputCostPer1M: 2, capabilities: ["text", "fast"], isActive: true },
      { id: "o3", name: "o3 Reasoning", contextWindow: 200000, maxOutput: 100000, inputCostPer1M: 15, outputCostPer1M: 60, capabilities: ["reasoning", "code", "vision"], isActive: true },
      { id: "o3-pro", name: "o3 Pro", contextWindow: 200000, maxOutput: 100000, inputCostPer1M: 30, outputCostPer1M: 120, capabilities: ["reasoning", "code"], isActive: true },
      { id: "o4-mini", name: "o4 Mini", contextWindow: 200000, maxOutput: 100000, inputCostPer1M: 1.1, outputCostPer1M: 4.4, capabilities: ["reasoning", "code", "fast"], isActive: true },
      { id: "gpt-4.1", name: "GPT-4.1", contextWindow: 1000000, maxOutput: 32768, inputCostPer1M: 2.5, outputCostPer1M: 10, capabilities: ["text", "code"], isActive: true },
      { id: "gpt-4.1-mini", name: "GPT-4.1 Mini", contextWindow: 1000000, maxOutput: 16384, inputCostPer1M: 0.4, outputCostPer1M: 1.6, capabilities: ["text", "code", "fast"], isActive: true },
  ...
  },
  {
    ...
    models: [
      { id: "glm-4.6v", name: "GLM-4.6V (106B Multimodal)", contextWindow: 128000, maxOutput: 8192, inputCostPer1M: 0.3, outputCostPer1M: 0.9, capabilities: ["text", "vision", "multimodal", "code", "reasoning"], isDefault: true, isActive: true },
      { id: "glm-4.6v-flash", name: "GLM-4.6V Flash (9B)", contextWindow: 128000, maxOutput: 8192, inputCostPer1M: 0, outputCostPer1M: 0, capabilities: ["text", "vision", "multimodal", "fast"], isActive: true },
      { id: "glm-4.6", name: "GLM-4.6", contextWindow: 200000, maxOutput: 8192, inputCostPer1M: 0.6, outputCostPer1M: 2.2, capabilities: ["text", "code", "reasoning"], isActive: true },
      ...
      { id: "codegeex-4", name: "CodeGeeX 4", contextWindow: 128000, maxOutput: 8192, inputCostPer1M: 0.1, outputCostPer1M: 0.1, capabilities: ["code", "fast"], isActive: true },
    ]
  }
];
