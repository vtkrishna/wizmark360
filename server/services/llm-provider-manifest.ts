...
export const PROVIDER_MANIFESTS: ProviderManifest[] = [
  {
    ...
    models: [
      { id: "gpt-5.1", name: "GPT-5.1 Thinking", contextWindow: 200000, maxOutput: 100000, inputCostPer1M: 5, outputCostPer1M: 15, capabilities: ["text", "vision", "reasoning", "code"], isDefault: true, isActive: true },
      { id: "gpt-5.1-chat-latest", name: "GPT-5.1 Instant", contextWindow: 200000, maxOutput: 100000, inputCostPer1M: 2.5, outputCostPer1M: 10, capabilities: ["text", "vision", "multimodal", "fast"], isActive: true },
      { id: "gpt-5.1-codex", name: "GPT-5.1 Codex", contextWindow: 200000, maxOutput: 100000, inputCostPer1M: 5, outputCostPer1M: 15, capabilities: ["code", "reasoning"], isActive: true },
      { id: "gpt-5", name: "GPT-5", contextWindow: 128000, maxOutput: 32768, inputCostPer1M: 5, outputCostPer1M: 15, capabilities: ["text", "vision", "reasoning", "code"], isActive: true },
